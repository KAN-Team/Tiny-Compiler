...
namespace Tiny_Compiler
{
    class Initializer
    {
        ...
        public Initializer()
        {
            ...
            specialSymbols.Add("(", "Left Parenthesis - symbol");
            specialSymbols.Add(")", "Right Parenthesis - symbol");
            specialSymbols.Add("{", "Left Bracket - symbol");
            specialSymbols.Add("}", "Right Bracket - symbol");
        }
